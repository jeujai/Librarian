...
# NAT Gateway - Dedicated for this VPC
resource "aws_nat_gateway" "main" {
  ...
  tags = merge(var.tags, {
    Name = var.single_nat_gateway ? "${var.name_prefix}-nat-gateway" : "${var.name_prefix}-nat-gateway-${count.index + 1}"
  })
...
# Route Tables for Private Subnets - Use dedicated NAT Gateway
