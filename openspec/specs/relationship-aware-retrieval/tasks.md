...
- [x] 1.1 Add relationship-aware retrieval settings to the `Settings` class in `src/multimodal_librarian/config/config.py`
...
- [x] 2.1 Add `TraversalResult` dataclass to `src/multimodal_librarian/models/kg_retrieval.py`
...
- [x] 3.1 Create `src/multimodal_librarian/components/kg_retrieval/relationship_traverser.py` with `RelationshipTraverser` class
...
- [x] 3.2 Implement `_build_pair_cypher()` method
...
- [x] 3.3 Implement `traverse()` method
...
- [x] 3.4 Export `RelationshipTraverser` from `src/multimodal_librarian/components/kg_retrieval/__init__.py`
  - Add import and include in `__all__`

## Task 4: Implement Boost Application in KGRetrievalService

- [x] 4.1 Add `_apply_relationship_boost()` private method to `KGRetrievalService`
...
- [x] 5.1 Initialize `RelationshipTraverser` in `KGRetrievalService.__init__()` using config settings
  - Pass `neo4j_client`, `hop_limit`, `timeout_seconds`, `max_paths_per_pair` from Settings
  - Requirements: 7.1
- [x] 5.2 Add multi-concept detection and traversal call in `_stage1_kg_retrieval()`
...
- [x] 5.3 Add relationship-aware metadata to `KGRetrievalResult` in `retrieve()`
...
- [x] 6.1 Create `tests/components/test_relationship_traverser.py` with property-based tests using Hypothesis
...
- [x] 7.1 Add unit tests for `RelationshipTraverser` in `tests/components/test_relationship_traverser.py`
...
- [x] 7.2 Add integration test in `tests/integration/test_relationship_aware_retrieval.py`
