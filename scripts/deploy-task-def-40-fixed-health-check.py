#!/usr/bin/env python3
"""
Deploy task definition 40 with fixed curl health check.
...
def deploy_task_def_40():
    """Create and deploy task definition 40 with fixed curl health check."""
    ecs = boto3.client('ecs', region_name='us-east-1')
    
    print("=" * 80)
    print("Deploying Task Definition 40 with Fixed Curl Health Check")
    print("=" * 80)
    print()
    print("Using 127.0.0.1 instead of localhost for health check")
    print("Creating task definition with fixed curl-based health check...")
    print()
    ...
    # Create new task definition with fixed curl health check
    print("\n2. Creating new task definition with fixed curl health check...")
    
    # Update health check to use curl with 127.0.0.1
    ...
    print("  - Health check URL: http://127.0.0.1:8000/api/health/simple")
