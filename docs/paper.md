...
1. **UMLS 1-hop** — Direct clinical relationships via `SAME_AS` → `UMLS_REL` → `SAME_AS` bridge
...
*#RAG #KnowledgeGraph #NLP #MedicalAI #NER #VectorSearch #Python #Neo4j #LLM #MachineLearning #scispaCy #UMLS*
